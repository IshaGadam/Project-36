class Question {
  ...
  display(){
    ...
    this.question.html("Question:- What is the area of a square? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: side x side " );
    this.option1.position(150, 110);
    this.option2.html("2: length x breadth" );
    this.option2.position(150, 130);
    this.option3.html("3: side x side x side " );
    this.option3.position(150, 150);
    this.option4.html("4: base x height" );
    ...
    this.button.mousePressed(()=>{
       ...
       this.message.html("Thank You, Your Answer Has Been Submitted Successfully.");
